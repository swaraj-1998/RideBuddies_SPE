				...
				<div class="information-area mb-80 wow fadeInUp"
					...
					<div class="col-12">
						<form action="controllers/createcontroller.jsp" method="post">
							...
							<button type="submit" class="btn rehomes-btn mt-15 w-100">Delete</button>
						</form>
					</div>
...
<%
ArrayList<RequestDto> list = new RequestDao().viewAllRequest((String)session.getAttribute("phone"));
if(list.isEmpty()){
